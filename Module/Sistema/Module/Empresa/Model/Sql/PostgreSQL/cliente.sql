...
COMMENT ON COLUMN cliente.rut IS
	'RUT del cliente, sin puntos ni dígito verificador';
...
COMMENT ON COLUMN cliente.actividad_economica IS
	'Actividad económica del cliente (si posee una)';
...
COMMENT ON COLUMN cliente.direccion IS 'Dirección principal';
COMMENT ON COLUMN cliente.comuna IS 'Comuna de la dirección';
